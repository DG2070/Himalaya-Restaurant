...
import type { ApplicationFormValues } from "../form/application-schema";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import ApplicationView from "../../2-food-group/view";

export const applicationColumns: ColumnDef<ApplicationFormValues>[] = [
  {
    accessorKey: "name",
    header: "Applicant",
    cell: ({ row }) => {
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  onClick={() => {
                    deleteApplication.mutate(row.original.id!);
                  }}
                >
                  Continue
                </AlertDialogAction>
